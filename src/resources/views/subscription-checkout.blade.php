<div class="row">
    <div class="col-md-12">
        @component('components.box')
            @slot('box_title')
                @lang('Mojopay::labels.checkout.title')
            @endslot
            <p></p>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    {!! CoralsForm::text('card_number','Mojopay::attributes.mojopay.card_number',true,null) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-md-2 p-r-0">
                    {!! CoralsForm::number('expMonth','Mojopay::attributes.mojopay.expMonth',true,null,['data-securionpay'=>"expMonth", 'placeholder'=>"MM"]) !!}
                </div>
                <div class="col-md-2">
    ...
    <script>
        // Set Mojopay Public Key (from mojopay.co > log in > Keys tab)
        Mojopay.setPublicKey("pkey_test");
    </script>
    <script>
        ...
        function initMojopay() {
            $.getScript("https://cdn.mojopay.co/mojopay.js", function () {
